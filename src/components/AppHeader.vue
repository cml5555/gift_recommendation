<template>
  <div class="header">
    <span class="header-text">校园社区管理系统</span>
    <div class="header-right">
      <el-dropdown placement="bottom-start">
        <span class="el-dropdown-link icon-wrap">
          <img class="user-img" style="border-radius: 50%" src="../assets/people.png"/>
        </span>
      ...
      <div class="header-right-text">
        <div class="header-wellcome">欢迎你，admin</div>
...
export default {
  ...
  methods: {
    ...
    getusername() {
      ...
      this.name = JSON.parse(user).username;//转换赋值
    },
